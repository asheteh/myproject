def Banjara__Jaise_Banjare_Ko_Ghar_(request):
	...
	lists = Sargams.objects.filter(song_names__icontains='')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Banjara--Jaise-Banjare-Ko.html',context)

def Notes___Sargam_Baar_baar_din_ye_aye__happy_birthday_(request):
	text = Sargams.objects.filter(id__iexact =365)
	lists = Sargams.objects.filter(song_names__icontains='din')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Notes---Sargam-Baar.html',context)

def Notes___Sargam_Bade_Achhe_lagte_hai(request):
	text = Sargams.objects.filter(id__iexact =366)
	lists = Sargams.objects.filter(song_names__icontains='lagte')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Notes---Sargam-Bade.html',context)

def Notes___Sargam_Aye_mere_watan_ke_logo(request):
	text = Sargams.objects.filter(id__iexact =367)
	lists = Sargams.objects.filter(song_names__icontains='watan')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Notes---Sargam-Aye.html',context)

def Notes___Sargam_Bahut_Pyar_Karte_Hai(request):
	text = Sargams.objects.filter(id__iexact =368)
	lists = Sargams.objects.filter(song_names__icontains='Karte')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Notes---Sargam-Bahut.html',context)

def Notes___Sargam_Babuji_dheere_chalna(request):
	text = Sargams.objects.filter(id__iexact =369)
	lists = Sargams.objects.filter(song_names__icontains='chalna')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Notes---Sargam-Babuji.html',context)
...
def Notes___Sargam_Bahon_me_chale_aao(request):
	...
	context={'songs' : text,'lists':lists}
	return render(request,'music/Notes---Sargam-Bahon.html',context)

def Notes___Sargam_Bahut_door_mujhe_chale_jana_hai(request):
	text = Sargams.objects.filter(id__iexact =371)
	lists = Sargams.objects.filter(song_names__icontains='mujhe')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Notes---Sargam-Bahut.html',context)

def Notes___Sargam_Ankhon_me_teri_ajab_si(request):
	text = Sargams.objects.filter(id__iexact =372)
	lists = Sargams.objects.filter(song_names__icontains='teri')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Notes---Sargam-Ankhon.html',context)

def Notes___Sargam_Awarapan__Banjarapan(request):
	text = Sargams.objects.filter(id__iexact =373)
	lists = Sargams.objects.filter(song_names__icontains='Banjarapan')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Notes---Sargam-Awarapan.html',context)

def Notes___Sargam_Alvida__alvida(request):
	text = Sargams.objects.filter(id__iexact =374)
	lists = Sargams.objects.filter(song_names__icontains='alvida')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Notes---Sargam-Alvida.html',context)

def Notes___Sargam_Akele_hai_to_kya_gham_hai(request):
	text = Sargams.objects.filter(id__iexact =375)
	lists = Sargams.objects.filter(song_names__icontains='to')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Notes---Sargam-Akele.html',context)

def Notes___Sargam_Aja_re_mai_to_kab_se(request):
	text = Sargams.objects.filter(id__iexact =376)
	lists = Sargams.objects.filter(song_names__icontains='mai')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Notes---Sargam-Aja.html',context)

def Notes___Sargam_Apki_ankhon_me_kuchh(request):
	text = Sargams.objects.filter(id__iexact =377)
	lists = Sargams.objects.filter(song_names__icontains='me')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Notes---Sargam-Apki.html',context)

def Notes___Sargam_Albela_sajan_aayo_ree(request):
	text = Sargams.objects.filter(id__iexact =378)
	lists = Sargams.objects.filter(song_names__icontains='aayo')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Notes---Sargam-Albela.html',context)

def Notes___Sargam_Zindagi_kaisi_hai_paheli_haye(request):
	text = Sargams.objects.filter(id__iexact =379)
	lists = Sargams.objects.filter(song_names__icontains='hai')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Notes---Sargam-Zindagi.html',context)

def Notes___Sargam_Zindagi_mil_ke_bitayenge(request):
	text = Sargams.objects.filter(id__iexact =380)
	lists = Sargams.objects.filter(song_names__icontains='ke')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Notes---Sargam-Zindagi.html',context)

def Notes___Sargam_Zara_zara_mehekta_hai(request):
	text = Sargams.objects.filter(id__iexact =381)
	lists = Sargams.objects.filter(song_names__icontains='mehekta')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Notes---Sargam-Zara.html',context)

def Notes___Sargam_Ye_raate_ye_mausam_ye_nadi_ka_kinara(request):
	text = Sargams.objects.filter(id__iexact =382)
	lists = Sargams.objects.filter(song_names__icontains='ye')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Notes---Sargam-Ye.html',context)
...
def Notes___Sargam_Ye_nayan_dare_dare(request):
	...
	lists = Sargams.objects.filter(song_names__icontains='dare')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Notes---Sargam-Ye.html',context)

def Notes___Sargam_Awaz_deke_hame_tum_bulao(request):
	text = Sargams.objects.filter(id__iexact =385)
	lists = Sargams.objects.filter(song_names__icontains='hame')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Notes---Sargam-Awaz.html',context)

def Notes___Sargam_Ye_moh_moh_ke_dhaage(request):
	text = Sargams.objects.filter(id__iexact =386)
	lists = Sargams.objects.filter(song_names__icontains='moh')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Notes---Sargam-Ye.html',context)

def Notes___Sargam_Ye_kya_hua(request):
	text = Sargams.objects.filter(id__iexact =387)
	lists = Sargams.objects.filter(song_names__icontains='hua')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Notes---Sargam-Ye.html',context)

def Notes___Sargam_Ye_jo_mohabbat_hai(request):
	text = Sargams.objects.filter(id__iexact =388)
	lists = Sargams.objects.filter(song_names__icontains='mohabbat')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Notes---Sargam-Ye.html',context)
...
def Notes___Sargam_Ye_dil_Diwana_hai(request):
	...
	lists = Sargams.objects.filter(song_names__icontains='Diwana')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Notes---Sargam-Ye.html',context)

def Notes___Sargam_Ye_Awara_Raatein(request):
	text = Sargams.objects.filter(id__iexact =393)
	lists = Sargams.objects.filter(song_names__icontains='Raatein')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Notes---Sargam-Ye.html',context)

def Banjara__Jaise_Banjare_Ko_Ghar_(request):
	text = Sargams.objects.filter(id__iexact =364)
	lists = Sargams.objects.filter(song_names__icontains='Banjare')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Banjara--Jaise-Banjare-Ko.html',context)

def Notes___Sargam_Baar_baar_din_ye_aye__happy_birthday_(request):
	text = Sargams.objects.filter(id__iexact =365)
	lists = Sargams.objects.filter(song_names__icontains='Sargam')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Notes---Sargam-Baar.html',context)
...
def Notes___Sargam_Tumhe_apna_banaane_ki_kasam___ka_junoo(request):
	...
	lists = Sargams.objects.filter(song_names__icontains='Sargam')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Notes---Sargam-Tumhe.html',context)
...
def Notes___Sargam_Tum_se_hi_din_hota_hai(request):
	...
	lists = Sargams.objects.filter(song_names__icontains='Sargam')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Notes---Sargam-Tum.html',context)
...
def Notes___Sargam_Tumane_mujhe_dekha(request):
	...
	lists = Sargams.objects.filter(song_names__icontains='Sargam')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Notes---Sargam-Tumane.html',context)
...
def Notes___Sargam_Tujhse_naraz_nahi_zindagi(request):
	...
	lists = Sargams.objects.filter(song_names__icontains='Sargam')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Notes---Sargam-Tujhse.html',context)

def Notes___Sargam_Tujhe_dekh_dekh_sona(request):
	text = Sargams.objects.filter(id__iexact =417)
	lists = Sargams.objects.filter(song_names__icontains='Sargam')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Notes---Sargam-Tujhe.html',context)

def Notes___Sargam_Tu_Mile_Dil_Khile(request):
	text = Sargams.objects.filter(id__iexact =418)
	lists = Sargams.objects.filter(song_names__icontains='Sargam')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Notes---Sargam-Tu.html',context)
...
def Notes___Sargam_Teri_galliyan(request):
	...
	lists = Sargams.objects.filter(song_names__icontains='Sargam')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Notes---Sargam-Teri.html',context)
...
def Notes___Sargam_Tere_mast_mast_do_nain(request):
	...
	lists = Sargams.objects.filter(song_names__icontains='Sargam')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Notes---Sargam-Tere.html',context)
...
def Notes___Sargam_O_saathi_re(request):
	...
	lists = Sargams.objects.filter(song_names__icontains='Sargam')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Notes---Sargam-O.html',context)
...
def Notes___Sargam_Mera_mulk_mera_desh(request):
	...
	lists = Sargams.objects.filter(song_names__icontains='Sargam')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Notes---Sargam-Mera.html',context)
...
def Notes___Sargam_Mai_ye_soch_kar_uske_dar_se(request):
	...
	lists = Sargams.objects.filter(song_names__icontains='Sargam')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Notes---Sargam-Mai.html',context)

def Notes___Sargam_Lukka_chuppi(request):
	text = Sargams.objects.filter(id__iexact =500)
	lists = Sargams.objects.filter(song_names__icontains='Sargam')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Notes---Sargam-Lukka.html',context)
...
def Notes___Sargam_Kaha_tak_ye_man_ko(request):
	...
	lists = Sargams.objects.filter(song_names__icontains='Sargam')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Notes---Sargam-Kaha.html',context)
...
def Notes___Sargam_Hum_tere_sheher_me_aye_hai(request):
	...
	lists = Sargams.objects.filter(song_names__icontains='Sargam')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Notes---Sargam-Hum.html',context)
...
def Notes___Sargam_Humma_humma__ik_ho_gaye_hum_aur_tum_(request):
	...
	lists = Sargams.objects.filter(song_names__icontains='Sargam')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Notes---Sargam-Humma.html',context)
...
def Notes___Sargam_Gerua__Dhoop_se_nikal_ke_(request):
	...
	lists = Sargams.objects.filter(song_names__icontains='Sargam')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Notes---Sargam-Gerua.html',context)

def Notes___Sargam_Ek_daal_par_tota_bole(request):
	text = Sargams.objects.filter(id__iexact =569)
	lists = Sargams.objects.filter(song_names__icontains='Sargam')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Notes---Sargam-Ek.html',context)
...
def Sargam_And_Flute_Tum_Hi_Aana__Marjaavaan_(request):
	...
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-Tum-Hi.html',context)

def Sargam_And_Flute_Nanha_Munna_Rahi_Hoon__Son_Of_India_(request):
	text = Sargams.objects.filter(id__iexact =622)
	lists = Sargams.objects.filter(song_names__icontains='Nanha')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-Nanha-Munna.html',context)
...
def Sargam_And_Flute_Dil_De_Diya_Hain__Anand_Raj_Anand_(request):
	...
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-Dil-De.html',context)

def Sargam_And_Flute_Teri_Meri_Kahani__Happy_Hardy_And_Heer_(request):
	text = Sargams.objects.filter(id__iexact =624)
	lists = Sargams.objects.filter(song_names__icontains='Teri')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-Teri-Meri.html',context)

def Sargam_And_Flute_Shikwa_Nahi__Jubin_Nautiyal_(request):
	text = Sargams.objects.filter(id__iexact =625)
	lists = Sargams.objects.filter(song_names__icontains='Shikwa')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-Shikwa-Nahi.html',context)
...
def Sargam_And_Flute_Mere_Saamne_Wali_Khidhi_Mein__Padosan_(request):
	...
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-Mere-Saamne.html',context)

def Sargam_And_Flute_Thodi_Jagah__Marjaavaan_(request):
	text = Sargams.objects.filter(id__iexact =627)
	lists = Sargams.objects.filter(song_names__icontains='Thodi')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-Thodi-Jagah.html',context)

def Sargam_And_Flute_Mere_Mehboob_Qayamat_Hogi__Kishore_Kumar_(request):
	text = Sargams.objects.filter(id__iexact =628)
	lists = Sargams.objects.filter(song_names__icontains='Mere')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-Mere-Mehboob.html',context)

def Sargam_And_Flute_Surili_Akhiyon_Wale__Veer_(request):
	text = Sargams.objects.filter(id__iexact =629)
	lists = Sargams.objects.filter(song_names__icontains='Surili')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-Surili-Akhiyon.html',context)
...
def Sargam_And_Flute_Chura_Liya_Hai_Tumne_Jo_Dil_Ko__Yaadon_Ki_Baaraat_(request):
	...
	lists = Sargams.objects.filter(song_names__icontains='Chura')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-Chura-Liya.html',context)

def Sargam_And_Flute_Duniyaa__Luka_Chuppi_(request):
	text = Sargams.objects.filter(id__iexact =631)
	lists = Sargams.objects.filter(song_names__icontains='Duniyaa')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-Duniyaa-.html',context)
...
def Sargam_And_Flute_Pyar_Diwana_Hota_Hai__Kati_Patang_(request):
	...
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-Pyar-Diwana.html',context)

def Sargam_And_Flute_Phoolon_Ka_Taaron_Ka__Hare_Rama_Hare_Krishna_(request):
	text = Sargams.objects.filter(id__iexact =633)
	lists = Sargams.objects.filter(song_names__icontains='Phoolon')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-Phoolon-Ka.html',context)

def Sargam_And_Flute_Raabta__Agent_Vinod___Full_Song_(request):
	text = Sargams.objects.filter(id__iexact =634)
	lists = Sargams.objects.filter(song_names__icontains='Raabta')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-Raabta-.html',context)

def Sargam_And_Flute_Dil_Mein_Ho_Tum__Why_Cheat_India_(request):
	text = Sargams.objects.filter(id__iexact =635)
	lists = Sargams.objects.filter(song_names__icontains='Dil')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-Dil-Mein.html',context)

def Sargam_And_Flute_Sanu_Ek_Pal_Chain__Raid_(request):
	text = Sargams.objects.filter(id__iexact =636)
	lists = Sargams.objects.filter(song_names__icontains='Sanu')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-Sanu-Ek.html',context)

def Sargam_And_Flute_Gulabi_Ankhen__The_Train_(request):
	text = Sargams.objects.filter(id__iexact =637)
	lists = Sargams.objects.filter(song_names__icontains='Gulabi')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-Gulabi-Ankhen.html',context)

def Sargam_And_Flute_Ek_Ajnabee_Haseena_Se__Ajnabee_(request):
	text = Sargams.objects.filter(id__iexact =638)
	lists = Sargams.objects.filter(song_names__icontains='Ek')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-Ek-Ajnabee.html',context)

def Sargam_And_Flute_Aadat__Jal_(request):
	text = Sargams.objects.filter(id__iexact =639)
	lists = Sargams.objects.filter(song_names__icontains='Aadat')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-Aadat-.html',context)

def Sargam_And_Flute_Kuch_Kuch_Hota_Hai__Title_Song_(request):
	text = Sargams.objects.filter(id__iexact =640)
	lists = Sargams.objects.filter(song_names__icontains='Kuch')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-Kuch-Kuch.html',context)

def Sargam_And_Flute_Achyutam_Keshavam(request):
	text = Sargams.objects.filter(id__iexact =641)
	lists = Sargams.objects.filter(song_names__icontains='Achyutam')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-Achyutam-Keshavam.html',context)

def Sargam_And_Flute_Dekha_Hazaro_Dafaa__Rustom_(request):
	text = Sargams.objects.filter(id__iexact =642)
	lists = Sargams.objects.filter(song_names__icontains='Dekha')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-Dekha-Hazaro.html',context)

def Sargam_And_Flute_Kalank__Title_Track_(request):
	text = Sargams.objects.filter(id__iexact =643)
	lists = Sargams.objects.filter(song_names__icontains='Kalank')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-Kalank-.html',context)

def Sargam_And_Flute_Nani_Teri_Morni_Ko_Mor_Le_Gaye(request):
	text = Sargams.objects.filter(id__iexact =644)
	lists = Sargams.objects.filter(song_names__icontains='Nani')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-Nani-Teri.html',context)

def Sargam_And_Flute_Main_Hoon_Hero_Tera__Salman_Khan_(request):
	text = Sargams.objects.filter(id__iexact =645)
	lists = Sargams.objects.filter(song_names__icontains='Main')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-Main-Hoon.html',context)

def Sargam_And_Flute_Pachtaoge__Arijit_Singh_(request):
	text = Sargams.objects.filter(id__iexact =646)
	lists = Sargams.objects.filter(song_names__icontains='Pachtaoge')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-Pachtaoge-.html',context)

def Sargam_And_Flute_Luka_Chuppi__Lata_Mangeshkar_(request):
	text = Sargams.objects.filter(id__iexact =647)
	lists = Sargams.objects.filter(song_names__icontains='Luka')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-Luka-Chuppi.html',context)

def Sargam_And_Flute_Hawayein__Jab_Harry_Met_Sejal_(request):
	text = Sargams.objects.filter(id__iexact =648)
	lists = Sargams.objects.filter(song_names__icontains='Hawayein')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-Hawayein-.html',context)

def Sargam_And_Flute_Banjaara__Ek_Villain_(request):
	text = Sargams.objects.filter(id__iexact =649)
	lists = Sargams.objects.filter(song_names__icontains='Banjaara')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-Banjaara-.html',context)

def Sargam_And_Flute_Jiya_Dhadak_Dhadak_Jaye__Kalyug_(request):
	text = Sargams.objects.filter(id__iexact =650)
	lists = Sargams.objects.filter(song_names__icontains='Jiya')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-Jiya-Dhadak.html',context)
...
def Sargam_And_Flute_Mile_Ho_Tum__Fever_(request):
	...
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-Mile-Ho.html',context)

def Sargam_And_Flute_Maa__Taare_Zameen_Par_(request):
	text = Sargams.objects.filter(id__iexact =652)
	lists = Sargams.objects.filter(song_names__icontains='Maa')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-Maa-.html',context)

def Sargam_And_Flute_The_Jungle_Book__Title_Song_(request):
	text = Sargams.objects.filter(id__iexact =653)
	lists = Sargams.objects.filter(song_names__icontains='The')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-The-Jungle.html',context)

def Sargam_And_Flute_Afreen_Afreen__Coke_Studio_(request):
	text = Sargams.objects.filter(id__iexact =654)
	lists = Sargams.objects.filter(song_names__icontains='Afreen')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-Afreen-Afreen.html',context)

def Sargam_And_Flute_Jab_Se_Tere_Naina__Saawariya_(request):
	text = Sargams.objects.filter(id__iexact =655)
	lists = Sargams.objects.filter(song_names__icontains='Jab')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-Jab-Se.html',context)

def Sargam_And_Flute_Jeena_Jeena__Full_Song___Badlapur_(request):
	text = Sargams.objects.filter(id__iexact =656)
	lists = Sargams.objects.filter(song_names__icontains='Jeena')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-Jeena-Jeena.html',context)

def Sargam_And_Flute_Bum_Bum_Bole__Taare_Zameen_Par_(request):
	text = Sargams.objects.filter(id__iexact =657)
	lists = Sargams.objects.filter(song_names__icontains='Bum')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-Bum-Bum.html',context)

def Sargam_And_Flute_Sare_Jahan_Se_Achaa(request):
	text = Sargams.objects.filter(id__iexact =658)
	lists = Sargams.objects.filter(song_names__icontains='Sare')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-Sare-Jahan.html',context)
...
def Sargam_And_Flute_Bolna__Kapoor_And_Sons_(request):
	...
	lists = Sargams.objects.filter(song_names__icontains='Bolna')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-Bolna-.html',context)

def Sargam_And_Flute_Yaaron_Dosti_Badi_Hi__K_K__(request):
	text = Sargams.objects.filter(id__iexact =661)
	lists = Sargams.objects.filter(song_names__icontains='Yaaron')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-Yaaron-Dosti.html',context)

def Sargam_And_Flute_Sau_Dard_Hai__Jaan_E_Mann_(request):
	text = Sargams.objects.filter(id__iexact =662)
	lists = Sargams.objects.filter(song_names__icontains='Sau')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-Sau-Dard.html',context)
...
def Sargam_And_Flute_Tu_Hi_Haqeeqat__Tum_Mile_(request):
	...
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-Tu-Hi.html',context)

def Sargam_And_Flute_Zindagi_Do_Pal_Ki__Kites_(request):
	text = Sargams.objects.filter(id__iexact =664)
	lists = Sargams.objects.filter(song_names__icontains='Zindagi')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-Zindagi-Do.html',context)

def Sargam_And_Flute_Dil_Kyun_Yeh_Mera__Kites_(request):
	text = Sargams.objects.filter(id__iexact =665)
	lists = Sargams.objects.filter(song_names__icontains='Dil')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-Dil-Kyun.html',context)

def Sargam_And_Flute_Tu_Jaane_Na__Ajab_Prem_Ki_Ghazab_Kahani_(request):
	text = Sargams.objects.filter(id__iexact =666)
	lists = Sargams.objects.filter(song_names__icontains='Tu')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-Tu-Jaane.html',context)

def Sargam_And_Flute_Lakdi_Ki_Kaathi__Masoom_(request):
	text = Sargams.objects.filter(id__iexact =667)
	lists = Sargams.objects.filter(song_names__icontains='Lakdi')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-Lakdi-Ki.html',context)

def Sargam_And_Flute_Kaise_Hua__Kabir_Singh_(request):
	text = Sargams.objects.filter(id__iexact =668)
	lists = Sargams.objects.filter(song_names__icontains='Kaise')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-Kaise-Hua.html',context)

def Sargam_And_Flute_Channa_Mereya__Ae_Dil_Hai_Mushkil_(request):
	text = Sargams.objects.filter(id__iexact =669)
	lists = Sargams.objects.filter(song_names__icontains='Channa')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-Channa-Mereya.html',context)

def Sargam_And_Flute_Tujhe_Dekha_To_Yeh_Jana_Sanam__DDLJ_(request):
	text = Sargams.objects.filter(id__iexact =670)
	lists = Sargams.objects.filter(song_names__icontains='Tujhe')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-Tujhe-Dekha.html',context)

def Sargam_And_Flute_Tera_Ban_Jaunga__Kabir_Singh_(request):
	text = Sargams.objects.filter(id__iexact =671)
	lists = Sargams.objects.filter(song_names__icontains='Tera')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-Tera-Ban.html',context)

def Sargam_And_Flute_Namo_Namo__Kedarnath_(request):
	text = Sargams.objects.filter(id__iexact =672)
	lists = Sargams.objects.filter(song_names__icontains='Namo')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-Namo-Namo.html',context)

def Sargam_And_Flute_Tera_Ghata__Gajendra_Verma_(request):
	text = Sargams.objects.filter(id__iexact =673)
	lists = Sargams.objects.filter(song_names__icontains='Tera')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-Tera-Ghata.html',context)

def Sargam_And_Flute_Main_Jahaan_Rahoon__Namastey_London_(request):
	text = Sargams.objects.filter(id__iexact =674)
	lists = Sargams.objects.filter(song_names__icontains='Main')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-Main-Jahaan.html',context)

def Sargam_And_Flute_Mere_Rashke_Qamar__Baadshaho_(request):
	text = Sargams.objects.filter(id__iexact =675)
	lists = Sargams.objects.filter(song_names__icontains='Mere')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-Mere-Rashke.html',context)

def Sargam_And_Flute_Barso_Re_Megha_Megha__Guru_(request):
	text = Sargams.objects.filter(id__iexact =676)
	lists = Sargams.objects.filter(song_names__icontains='Barso')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-Barso-Re.html',context)

def Sargam_And_Flute_Janam_Janam__Dilwale_(request):
	text = Sargams.objects.filter(id__iexact =677)
	lists = Sargams.objects.filter(song_names__icontains='Janam')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-Janam-Janam.html',context)

def Sargam_And_Flute_Hothon_Se_Chhulo_Tum__Jagjit_Singh_(request):
	text = Sargams.objects.filter(id__iexact =678)
	lists = Sargams.objects.filter(song_names__icontains='Hothon')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-Hothon-Se.html',context)

def Sargam_And_Flute_Tera_Yaar_Hoon_Main__Sonu_Ke_Tittu_Ki_Sweety_(request):
	text = Sargams.objects.filter(id__iexact =679)
	lists = Sargams.objects.filter(song_names__icontains='Tera')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-Tera-Yaar.html',context)

def Sargam_And_Flute_Yaara_Teri_Yaari(request):
	text = Sargams.objects.filter(id__iexact =680)
	lists = Sargams.objects.filter(song_names__icontains='Yaara')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-Yaara-Teri.html',context)

def Sargam_And_Flute_Aaoge_Jab_Tum__Jab_We_Met_(request):
	text = Sargams.objects.filter(id__iexact =681)
	lists = Sargams.objects.filter(song_names__icontains='Aaoge')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-Aaoge-Jab.html',context)

def Sargam_And_Flute_Basabriyaan__M_S__Dhoni(request):
	text = Sargams.objects.filter(id__iexact =682)
	lists = Sargams.objects.filter(song_names__icontains='Basabriyaan')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-Basabriyaan-.html',context)

def The_Untold_Story_(request):
	text = Sargams.objects.filter(id__iexact =683)
	lists = Sargams.objects.filter(song_names__icontains='')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/The-Untold-Story-.html',context)

def Sargam_And_Flute_Bekhayali__Kabir_Singh_(request):
	text = Sargams.objects.filter(id__iexact =684)
	lists = Sargams.objects.filter(song_names__icontains='Bekhayali')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-Bekhayali-.html',context)

def Sargam_And_Flute_Ajj_Din_Chadheya__Love_Aaj_Kal_(request):
	text = Sargams.objects.filter(id__iexact =685)
	lists = Sargams.objects.filter(song_names__icontains='Ajj')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-Ajj-Din.html',context)

def Sargam_And_Flute_Tujhko_Jo_Paaya__Crook_(request):
	text = Sargams.objects.filter(id__iexact =686)
	lists = Sargams.objects.filter(song_names__icontains='Tujhko')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-Tujhko-Jo.html',context)

def Sargam_And_Flute_Abhi_Mujh_Mein_Kahin__Agneepath_(request):
	text = Sargams.objects.filter(id__iexact =687)
	lists = Sargams.objects.filter(song_names__icontains='Abhi')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-Abhi-Mujh.html',context)

def Sargam_And_Flute_Dhadak__Title_Song_(request):
	text = Sargams.objects.filter(id__iexact =688)
	lists = Sargams.objects.filter(song_names__icontains='Dhadak')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-Dhadak-.html',context)

def Sargam_And_Flute_Ishq_Sufiana__The_Dirty_Picture_(request):
	text = Sargams.objects.filter(id__iexact =689)
	lists = Sargams.objects.filter(song_names__icontains='Ishq')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-Ishq-Sufiana.html',context)

def Sargam_And_Flute_Vaaste__Dhvani_Bhanushali___Full_Song_(request):
	text = Sargams.objects.filter(id__iexact =690)
	lists = Sargams.objects.filter(song_names__icontains='Vaaste')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-Vaaste-.html',context)

def Sargam_And_Flute_Phir_Kabhi__M_S__Dhoni_(request):
	text = Sargams.objects.filter(id__iexact =691)
	lists = Sargams.objects.filter(song_names__icontains='Phir')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-Phir-Kabhi.html',context)

def Sargam_And_Flute_Zaalima__Raees_(request):
	text = Sargams.objects.filter(id__iexact =692)
	lists = Sargams.objects.filter(song_names__icontains='Zaalima')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-Zaalima-.html',context)
...
def Sargam_And_Flute_Har_Kisi_Ko_Nahi_Milta_Yahan_Pyaar_Zindgi_Mein__Boss_(request):
	...
	lists = Sargams.objects.filter(song_names__icontains='Har')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-Har-Kisi.html',context)

def Sargam_And_Flute_Dil_Diyan_Gallan__Tiger_Zinda_Hai_(request):
	text = Sargams.objects.filter(id__iexact =694)
	lists = Sargams.objects.filter(song_names__icontains='Dil')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-Dil-Diyan.html',context)

def Sargam_And_Flute_Tujh_Mein_Rab_Dikhta_Hai__Rab_Ne_Banadi_Jodi__(request):
	text = Sargams.objects.filter(id__iexact =695)
	lists = Sargams.objects.filter(song_names__icontains='Tujh')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-Tujh-Mein.html',context)

def Sargam_And_Flute_Tu_Hai_Ki_Nahi__Roy_(request):
	text = Sargams.objects.filter(id__iexact =696)
	lists = Sargams.objects.filter(song_names__icontains='Tu')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-Tu-Hai.html',context)

def Sargam_And_Flute_Mast_Magan__2_States_(request):
	text = Sargams.objects.filter(id__iexact =697)
	lists = Sargams.objects.filter(song_names__icontains='Mast')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-Mast-Magan.html',context)

def Sargam_And_Flute_Maana_Ke_Hum_Yaar_Nahi__Meri_Pyaari_Bindu_(request):
	text = Sargams.objects.filter(id__iexact =698)
	lists = Sargams.objects.filter(song_names__icontains='Maana')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-Maana-Ke.html',context)

def Sargam_And_Flute_Sanam_Re__Tile_Song_(request):
	text = Sargams.objects.filter(id__iexact =699)
	lists = Sargams.objects.filter(song_names__icontains='Sanam')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-Sanam-Re.html',context)

def Sargam_And_Flute_Tujhe_Kitna_Chahne_Lage__Kabir_Singh_(request):
	text = Sargams.objects.filter(id__iexact =700)
	lists = Sargams.objects.filter(song_names__icontains='Tujhe')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-Tujhe-Kitna.html',context)

def Sargam_And_Flute_Girl_I_Need_You__Baaghi_(request):
	text = Sargams.objects.filter(id__iexact =701)
	lists = Sargams.objects.filter(song_names__icontains='Girl')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-Girl-I.html',context)

def Sargam_And_Flute_Mujhe_Kaise_Pata_Na_Chala__Papon_(request):
	text = Sargams.objects.filter(id__iexact =702)
	lists = Sargams.objects.filter(song_names__icontains='Mujhe')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-Mujhe-Kaise.html',context)

def Sargam_And_Flute_Maula_Mera_Le_Le_Meri_Jann__Chak_De_India_(request):
	text = Sargams.objects.filter(id__iexact =703)
	lists = Sargams.objects.filter(song_names__icontains='Maula')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-Maula-Mera.html',context)

def Sargam_And_Flute_Har_Ghadi__Kal_Ho_Na_Ho_(request):
	text = Sargams.objects.filter(id__iexact =704)
	lists = Sargams.objects.filter(song_names__icontains='Har')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-Har-Ghadi.html',context)

def Sargam_And_Flute_Jee_Le_Zara__Talaash_(request):
	text = Sargams.objects.filter(id__iexact =705)
	lists = Sargams.objects.filter(song_names__icontains='Jee')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-Jee-Le.html',context)

def Sargam_And_Flute_Zara_Zara__RHTDM_(request):
	text = Sargams.objects.filter(id__iexact =706)
	lists = Sargams.objects.filter(song_names__icontains='Zara')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-Zara-Zara.html',context)

def Sargam_And_Flute_Iktara__Wake_Up_Sid_(request):
	text = Sargams.objects.filter(id__iexact =707)
	lists = Sargams.objects.filter(song_names__icontains='Iktara')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-Iktara-.html',context)
...
def Sargam_And_Flute_Kabhi_Jo_Badal_Barse__Jackpot_(request):
	...
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-Kabhi-Jo.html',context)

def Sargam_And_Flute_Tune_Mere_Jaana__Emptiness_(request):
	text = Sargams.objects.filter(id__iexact =709)
	lists = Sargams.objects.filter(song_names__icontains='Tune')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-Tune-Mere.html',context)

def Sargam_And_Flute_Ve_maahi__Kesari_(request):
	text = Sargams.objects.filter(id__iexact =710)
	lists = Sargams.objects.filter(song_names__icontains='Ve')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-Ve-maahi.html',context)

def Sargam_And_Flute_Mitwa__Kabhi_Alvida_Na_Kehna_(request):
	text = Sargams.objects.filter(id__iexact =711)
	lists = Sargams.objects.filter(song_names__icontains='Mitwa')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-Mitwa-.html',context)

def Sargam_And_Flute_Bhagwan_Hain_Kahan_Re_Tu_(request):
	text = Sargams.objects.filter(id__iexact =712)
	lists = Sargams.objects.filter(song_names__icontains='Bhagwan')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-Bhagwan-Hain.html',context)

def Sargam__And_Flute_Aao_Na(request):
	text = Sargams.objects.filter(id__iexact =713)
	lists = Sargams.objects.filter(song_names__icontains='Flute')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam--And-Flute-Aao.html',context)
...
def Sargam_and_Flute_Pyaar_Ke_Pal__K_K____Sargam_And_Flute_Tum_Se_Hi__Jab_We_Met_(request):
	...
	lists = Sargams.objects.filter(song_names__icontains='Pyaar')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-and-Flute-Pyaar-Ke.html',context)

def Sargam_And_Flute_Meherbaani(request):
	text = Sargams.objects.filter(id__iexact =716)
	lists = Sargams.objects.filter(song_names__icontains='Meherbaani')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-Meherbaani.html',context)

def Sargam_And_Flute_Choo_Lo__The_Local_Train_(request):
	text = Sargams.objects.filter(id__iexact =717)
	lists = Sargams.objects.filter(song_names__icontains='Choo')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-Choo-Lo.html',context)

def Sargam_And_Flute_Kuch_Is_Taraha__Doorie_(request):
	text = Sargams.objects.filter(id__iexact =718)
	lists = Sargams.objects.filter(song_names__icontains='Kuch')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-Kuch-Is.html',context)

def Sargam_And_Flute_Emptiness(request):
	text = Sargams.objects.filter(id__iexact =719)
	lists = Sargams.objects.filter(song_names__icontains='Emptiness')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-Emptiness.html',context)

def Sargam_And_Flute_Teri_Mitti_(request):
	text = Sargams.objects.filter(id__iexact =720)
	lists = Sargams.objects.filter(song_names__icontains='Teri')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-Teri-Mitti.html',context)

def Indian_Flute_And_Sargam_Te_Amo(request):
	text = Sargams.objects.filter(id__iexact =721)
	lists = Sargams.objects.filter(song_names__icontains='Sargam')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Indian-Flute-And-Sargam-Te.html',context)

def Sargam_And_Flute_Laadki(request):
	text = Sargams.objects.filter(id__iexact =722)
	lists = Sargams.objects.filter(song_names__icontains='Laadki')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-Laadki.html',context)

def Sargam_And_Flute_Muskurane(request):
	text = Sargams.objects.filter(id__iexact =723)
	lists = Sargams.objects.filter(song_names__icontains='Muskurane')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-Muskurane.html',context)

def Sargam_And_Flute_Pee_Loon(request):
	text = Sargams.objects.filter(id__iexact =724)
	lists = Sargams.objects.filter(song_names__icontains='Pee')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-Pee-Loon.html',context)

def Sargam_And_Flute_Game_Of_Thrones(request):
	text = Sargams.objects.filter(id__iexact =725)
	lists = Sargams.objects.filter(song_names__icontains='Game')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-Game-Of.html',context)

def Sargam_And_Flute_Perfect__Ed_Sheeran_(request):
	text = Sargams.objects.filter(id__iexact =726)
	lists = Sargams.objects.filter(song_names__icontains='Perfect')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-Perfect-.html',context)

def Sargam_And_Flute_See_You_Again_ft__Charlie_Puth__Wiz_Khalifa_(request):
	text = Sargams.objects.filter(id__iexact =727)
	lists = Sargams.objects.filter(song_names__icontains='See')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-See-You.html',context)

def Sargam_And_Flute_Rive_Flow_In_You__Yiruma_(request):
	text = Sargams.objects.filter(id__iexact =728)
	lists = Sargams.objects.filter(song_names__icontains='Rive')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-Rive-Flow.html',context)

def Sargam_And_Flute_Pirates_Of_The_Caribbean(request):
	text = Sargams.objects.filter(id__iexact =729)
	lists = Sargams.objects.filter(song_names__icontains='Pirates')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-Pirates-Of.html',context)

def Sargam_And_Flute_Harry_Potter__Theme_Song_(request):
	text = Sargams.objects.filter(id__iexact =730)
	lists = Sargams.objects.filter(song_names__icontains='Harry')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-Harry-Potter.html',context)

def Sargam_And_Flute_On_My_Way__Alan_Walker_(request):
	text = Sargams.objects.filter(id__iexact =731)
	lists = Sargams.objects.filter(song_names__icontains='On')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-On-My.html',context)

def Sargam_And_Flute_The_Last_Of_Mohicans_(request):
	text = Sargams.objects.filter(id__iexact =732)
	lists = Sargams.objects.filter(song_names__icontains='The')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-The-Last.html',context)

def Sargam_And_Flute_Jingle_Bells(request):
	text = Sargams.objects.filter(id__iexact =733)
	lists = Sargams.objects.filter(song_names__icontains='Jingle')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-Jingle-Bells.html',context)

def Sargam_And_Flute_Doraemon___Zindagi_Sawarn_Doon_(request):
	text = Sargams.objects.filter(id__iexact =734)
	lists = Sargams.objects.filter(song_names__icontains='Doraemon')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-Doraemon-.html',context)

def Sargam_And_Flute_Happy_Birthday(request):
	text = Sargams.objects.filter(id__iexact =735)
	lists = Sargams.objects.filter(song_names__icontains='Happy')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-Happy-Birthday.html',context)

def Sargam_And_Flute_Fadad__Alan_Walker_(request):
	text = Sargams.objects.filter(id__iexact =736)
	lists = Sargams.objects.filter(song_names__icontains='Fadad')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-Fadad-.html',context)

def Sargam_And_Flute_Moh_Moh_ke_dhaage__Dum_Laga_Ke_Haisha_(request):
	text = Sargams.objects.filter(id__iexact =737)
	lists = Sargams.objects.filter(song_names__icontains='Moh')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-Moh-Moh.html',context)

def Sargam_And_Flute_Yeh_Aaina__Kabir_Singh_(request):
	text = Sargams.objects.filter(id__iexact =738)
	lists = Sargams.objects.filter(song_names__icontains='Yeh')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-Yeh-Aaina.html',context)

def Sargam_And_Flute_Yaara__Mamta_Sharma_(request):
	text = Sargams.objects.filter(id__iexact =739)
	lists = Sargams.objects.filter(song_names__icontains='Yaara')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-Yaara-.html',context)

def Sargam_And_Flute_Samjhawan__Humpty_Sharma_Ki_Dulhania_(request):
	text = Sargams.objects.filter(id__iexact =740)
	lists = Sargams.objects.filter(song_names__icontains='Samjhawan')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-Samjhawan-.html',context)

def Sargam_And_Flute_Tu_Mileya__Darshan_Raval_(request):
	text = Sargams.objects.filter(id__iexact =741)
	lists = Sargams.objects.filter(song_names__icontains='Tu')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-Tu-Mileya.html',context)

def Sargam_And_Flute_Intezaar__Arijit_Singh_(request):
	text = Sargams.objects.filter(id__iexact =742)
	lists = Sargams.objects.filter(song_names__icontains='Intezaar')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-Intezaar-.html',context)

def Sargam_And_Flute_Dekhte_Dekhte__Batti_Gul_Meter_Chalu_(request):
	text = Sargams.objects.filter(id__iexact =743)
	lists = Sargams.objects.filter(song_names__icontains='Dekhte')[:10]
	context={'songs' : text,'lists':lists}
	return render(request,'music/Sargam-And-Flute-Dekhte-Dekhte.html',context)
